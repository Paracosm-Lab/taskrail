...
**Goal:** Add the `migration_safety` cookbook queue so StupidClaw can map migration impact, enumerate migration risks, draft rollback procedures, exercise rollback in Docker-friendly staging, and produce a reviewed migration runbook.

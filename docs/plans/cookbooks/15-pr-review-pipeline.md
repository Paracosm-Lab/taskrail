...
**Goal:** Add the `pr_review` cookbook queue so StupidClaw can run mechanical PR checks, security scan, coverage review, architectural review, and then hand a compact evidence bundle to a human reviewer.

...
Bring StupidClaw into compliance with the Scribbl service standards baseline for:
- API conventions
...
1. Add canonical service runbook file: `docs/runbooks/stupidclaw.md`.
...
- Add `docs/runbooks/stupidclaw.md`.
...
6. `bin/check-runbooks` passes against `docs/runbooks/stupidclaw.md`.
...
- `STUPIDCLAW_SERVICE_TOKEN` (service-to-service auth)
- `STUPIDCLAW_ADMIN_TOKEN` (admin endpoint auth)

...
**Tech Stack:** Rails, RSpec, YAML queue seeds, TaskRail `inline_claude`, `shell_script`, and `fake` adapters, `Engine::PredicateRegistry`, `Engine::Predicates::*`, ActiveRecord artifacts/reports/claims.
...
- Work in repository: `/Users/gregmushen/work/code/taskrail`.
